        ...
        >
          ...
          <motion.div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto" variants={containerVariants}>
            <motion.div 
              ...
              className="group relative p-8 border-2 border-black/50 hover:border-black transition-all duration-500 bg-white rounded-lg"
            ...
            >
              ...
              <div className="relative">
                <motion.div 
                  className="w-24 h-24 bg-black rounded-full flex items-center justify-center mx-auto mb-8 group-hover:scale-110 transition-transform duration-300"
                ...
                <h4 className="text-2xl font-bold text-black mb-6 font-playfair">Precision Machining</h4>
            ...
            >
              ...
              <div className="relative">
                ...
                <h4 className="text-2xl font-bold text-black mb-6 font-playfair">Custom Manufacturing</h4>
                <p className="text-black leading-relaxed">
            ...
            >
              ...
              <div className="relative">
                ...
                <h4 className="text-2xl font-bold text-black
                 mb-6 font-playfair">Quality Assurance</h4>
                <p className="text-black leading-relaxed">
