...
export default function Footer() {
  ...
  return (
    <footer className="relative bg-gray-200 text-black">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 py-4">
        ...
        >
          ...
          <motion.div variants={itemVariants} className="flex flex-col h-full">
            ...
            <p className="text-black text-sm leading-relaxed mb-4 flex-grow font-medium text-center">
              {t('footer.tagline')}
            </p>
            <div className="text-black text-sm space-y-1 hidden md:block min-w-xl max-w-2xl">
              <p>{t('footer.copyright')}</p>
              <p>{t('footer.designed')} <a href="https://www.technovatechnologies.com/" className="text-red-400 hover:underline" target="_blank" rel="noopener noreferrer">Technova Technologies</a></p>
            </div>
          ...
          <motion.div variants={itemVariants}>
            <h4 className="text-sm font-semibold tracking-widest text-black mb-4 uppercase">{t('footer.useful.links')}</h4>
          ...
          {/* Get In Touch */}
          <motion.div variants={itemVariants}>
            <h4 className="text-sm font-semibold tracking-widest text-black mb-4 uppercase">{t('footer.get.in.touch')}</h4>
            <div className="space-y-3 mb-6">
              <div>
                <p className="text-sm text-black font-semibold">{t('footer.founders')}:</p>
                <p className="text-sm text-black mb-3">{t('footer.yash')}: <br/> +1(438)459-7766</p>
                <p className="text-sm text-black">{t('footer.paras')}: <br/> +1(438)459-7755</p>
              </div>
              <div>
                <p className="text-sm text-black font-semibold">{t('footer.address.label')}:</p>
                <p className="text-sm text-black">{t('footer.address.full')}</p>
              </div>
              <div>
                <p className="text-sm text-black font-semibold">{t('footer.email')}:</p>
            ...
            <div className="flex gap-2 sm:gap-4">
              <a href="https://www.instagram.com/karma.mechtech?igsh=MTBodWZ3c3BlZG1maw==" target="_blank" rel="noopener noreferrer" className="w-8 h-8 bg-gray-200 text-black rounded flex items-center justify-center hover:bg-gray-300 transition-colors">
              ...
              <a href="https://www.linkedin.com/company/karma-technologies-m%C3%A9caniques-inc/" target="_blank" rel="noopener noreferrer" className="w-8 h-8 bg-gray-200 text-black rounded flex items-center justify-center hover:bg-gray-300 transition-colors">
                <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
          ...
          {/* Map */}
          <motion.div variants={itemVariants}>
            <h4 className="text-sm font-semibold tracking-widest text-black mb-4 uppercase">{t('footer.location')}</h4>
